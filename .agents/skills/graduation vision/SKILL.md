...
## When To Use
Activate as part of the graduation pipeline, after the checklist passes.
Reads all existing idea documents and synthesizes them into `vision.md`.

## Output
Create `/ideas/[name]/vision.md` — this file travels with the idea into the
new build repo as `docs/vision.md`.
